...
export async function registerElasticsearchMocks(
  ...
  await page.route(`${esUrl}/**`, async (route) => {
    ...
    if (path === "/_health_report") {
      if (Object.prototype.hasOwnProperty.call(resolved, "healthReport")) {
        return json(resolved.healthReport);
      }
      return json({
        cluster_name: "mock-cluster",
        status: resolved.healthReportStatus ?? "yellow",
        indicators: {
          master_is_stable: {
            status: "green",
