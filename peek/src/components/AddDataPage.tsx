...
export default function AddDataPage() {
  ...
  // Reset derived OTLP state when ingest candidates change — render-time pattern per React docs
  ...
  // Auto-start polling when connection + API key are both available
  useEffect(() => {
  ...
  const selectedSignals = useMemo(
    () => selectedTechnology?.expectedSignals ?? [],
    [selectedTechnology],
  );
