...
import { formatCpu, formatMemory, type PodDetailRow } from "./k8sHelpers";

export default function K8sPodContainerTable({ rows }: { rows: PodDetailRow[] }) {
    ...
    <Paper variant="outlined" sx={{ overflow: "auto" }}>
      <Box sx={{ p: 2, borderBottom: 1, borderColor: "divider" }}>
        ...
        <Typography variant="body2" color="text.secondary">
          {rows.length} container{rows.length !== 1 ? "s" : ""} in this pod
        </Typography>
      </Box>
