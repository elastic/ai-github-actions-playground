...
On the Roles page, the detail pane shows an **Assigned users** section listing every user that holds the selected role. Use this to answer "who would be affected if I change this role?" during an incident or access review.
