...
export interface paths {
  ...
  "/_resolve/index/{name}": {
     ...
     *
     */
    post: operations["indices-resolve-index-1"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    /** @description Only to be used in query and path parameters, as the array form is actually a csv */
    "_types.Routing": string | string[];
    ...
    "_types.aggregations.AggregationContainer": {
      ...
      moving_avg?: Omit<
        components["schemas"]["_types.aggregations.MovingAverageAggregation"],
        "model"
      >;
    ...
    "_global.search._types.Rescore": {
      ...
      script?: components["schemas"]["_global.search._types.ScriptRescore"];
    };
    ...
    "_types.RetrieverContainer": {
      ...
      /** @description A retriever that diversifies the results from its child retriever. */
      diversify?: components["schemas"]["_types.DiversifyRetriever"];
    };
    ...
    "_types.RRFRetriever": components["schemas"]["_types.RetrieverBase"] & {
      ...
      retrievers: components["schemas"]["_types.RRFRetrieverEntry"][];
    ...
    /** @description Either a direct RetrieverContainer (backward compatible) or an RRFRetrieverComponent with weight. */
    "_types.RRFRetrieverEntry":
      | components["schemas"]["_types.RetrieverContainer"]
      | components["schemas"]["_types.RRFRetrieverComponent"];
    /** @description Wraps a retriever with an optional weight for RRF scoring. */
    "_types.RRFRetrieverComponent": {
      /** @description The nested retriever configuration. */
      retriever: components["schemas"]["_types.RetrieverContainer"];
      /**
    ...
    "_types.TextSimilarityReranker": components["schemas"]["_types.RetrieverBase"] & {
      ...
      chunk_rescorer?: components["schemas"]["_types.ChunkRescorer"];
    };
    "_types.ChunkRescorer": {
      ...
      chunking_settings?: components["schemas"]["_types.mapping.ChunkRescorerChunkingSettings"];
    };
    ...
    /** @enum {string} */
    "_types.ScoreNormalizer": "none" | "minmax" | "l2_norm";
    ...
    "_types.DiversifyRetriever": components["schemas"]["_types.RetrieverBase"] & {
      /** @description The diversification strategy to apply. */
      type: components["schemas"]["_types.DiversifyRetrieverTypes"];
    ...
    /** @enum {string} */
    "_types.DiversifyRetrieverTypes": "mmr";
    "_types.SlicedScroll": {
      field?: components["schemas"]["_types.Field"];
      id: components["schemas"]["_types.Id"];
      max: number;
    ...
    /** @enum {string} */
    "_types.VersionType": "internal" | "external" | "external_gte";
    ...
    "_types.query_dsl.SparseVectorQuery": components["schemas"]["_types.query_dsl.QueryBase"] &
      ({
        ...
        pruning_config?: components["schemas"]["_types.TokenPruningConfig"];
      } & {
    ...
    "_types.aggregations.BoxplotAggregation": components["schemas"]["_types.aggregations.MetricAggregationBase"] & {
       ...
       * @default default
       */
      execution_hint: components["schemas"]["_types.aggregations.TDigestExecutionHint"];
    };
    /** @enum {string} */
    "_types.aggregations.TDigestExecutionHint": "default" | "high_accuracy";
    ...
    "_types.mapping.DynamicTemplate": {
      ...
      mapping?: Omit<components["schemas"]["_types.mapping.Property"], "type">;
    ...
    "_types.mapping.Property":
      ...
      | components["schemas"]["_types.mapping.ExponentialHistogramProperty"]
    ...
    /** @enum {string} */
    "_types.mapping.DenseVectorElementType": "bit" | "byte" | "float" | "bfloat16";
    "_types.mapping.DenseVectorIndexOptions": {
      ...
      rescore_vector?: components["schemas"]["_types.mapping.DenseVectorIndexOptionsRescoreVector"];
      /**
    ...
    "_types.mapping.SemanticTextProperty": {
      ...
      index_options?: components["schemas"]["_types.mapping.SemanticTextIndexOptions"];
      ...
      chunking_settings?:
        | components["schemas"]["_types.mapping.ChunkingSettings"]
        | (string | null);
      /** @description Multi-fields allow the same string value to be indexed in multiple ways for different purposes, such as one
       *     field for search and a multi-field for sorting and aggregations, or the same string value analyzed by different analyzers. */
      fields?: {
    ...
    "_types.mapping.SemanticTextIndexOptions": {
      dense_vector?: components["schemas"]["_types.mapping.DenseVectorIndexOptions"];
      sparse_vector?: components["schemas"]["_types.mapping.SparseVectorIndexOptions"];
    };
    ...
    "_types.mapping.SparseVectorProperty": components["schemas"]["_types.mapping.PropertyBase"] & {
      ...
      index_options?: components["schemas"]["_types.mapping.SparseVectorIndexOptions"];
    } & {
      /**
       * @description discriminator enum property added by openapi-typescript
       * @enum {string}
    ...
    "_types.mapping.ExponentialHistogramProperty": components["schemas"]["_types.mapping.PropertyBase"] & {
      time_series_metric?: components["schemas"]["_types.mapping.TimeSeriesMetricType"];
      /** @enum {string} */
    ...
    "indices._types.DataStreamLifecycle": {
      ...
      downsampling?: components["schemas"]["indices._types.DownsamplingRound"][];
      ...
      downsampling_method?: components["schemas"]["indices._types.SamplingMethod"];
      /**
    ...
    "indices._types.DownsamplingRound": {
      ...
      after: components["schemas"]["_types.Duration"];
      /** @description The downsample interval. */
      fixed_interval: components["schemas"]["_types.DurationLarge"];
    };
    /** @enum {string} */
    "indices._types.SamplingMethod": "aggregate" | "last_value";
    ...
    "esql._types.ESQLParams":
      | components["schemas"]["esql._types.SingleOrMultiValue"][]
      | components["schemas"]["esql._types.NamedValue"][];
    "esql._types.SingleOrMultiValue":
      | components["schemas"]["_types.FieldValue"]
      | components["schemas"]["_types.FieldValue"][];
    "esql._types.NamedValue": {
      [key: string]: components["schemas"]["esql._types.SingleOrMultiValue"];
    };
    ...
    "indices._types.DataStream": {
      ...
      index_mode?: components["schemas"]["indices._types.IndexMode"];
    };
    ...
    "indices._types.ManagedBy":
      ...
      | "Unmanaged";
    /** @enum {string} */
    "indices._types.IndexMode": "standard" | "time_series" | "logsdb" | "lookup";
    ...
    "indices.resolve_index.ResolveIndexItem": {
      ...
      attributes: string[];
      data_stream?: components["schemas"]["_types.DataStreamName"];
      mode?: components["schemas"]["indices._types.IndexMode"];
    };
  ...
  parameters: {
    ...
    "field_caps-filters": string | string[];
    ...
    /** @description A comma-separated list of index names the mapping should be added to (supports wildcards).
    ...
    "indices.resolve_index-name": components["schemas"]["_types.Names"];
    /** @description Type of index that wildcard patterns can match.
     *     If the request can target data streams, this argument determines whether wildcard expressions match hidden data streams.
     *     Supports comma-separated values, such as `open,hidden`. */
    "indices.resolve_index-expand_wildcards": components["schemas"]["_types.ExpandWildcards"];
    /** @description If `false`, the request returns an error if it targets a missing or closed index. */
    "indices.resolve_index-ignore_unavailable": boolean;
    /** @description If `false`, the request returns an error if any wildcard expression, index alias, or `_all` value targets only missing or closed indices.
     *     This behavior applies even if the request targets other open indices.
     *     For example, a request targeting `foo*,bar*` returns an error if an index starts with `foo` but no index starts with `bar`. */
    "indices.resolve_index-allow_no_indices": boolean;
    ...
    "indices.resolve_index-mode":
      | components["schemas"]["indices._types.IndexMode"]
      | components["schemas"]["indices._types.IndexMode"][];
  };
  requestBodies: {
    field_caps: {
    ...
    requestBody: {
      content: {
        "application/json": {
          ...
          params?: components["schemas"]["esql._types.ESQLParams"];
  ...
  "indices-resolve-index": {
    parameters: {
      query?: {
         ...
         *     If the request can target data streams, this argument determines whether wildcard expressions match hidden data streams.
         *     Supports comma-separated values, such as `open,hidden`. */
        expand_wildcards?: components["parameters"]["indices.resolve_index-expand_wildcards"];
        /** @description If `false`, the request returns an error if it targets a missing or closed index. */
        ignore_unavailable?: components["parameters"]["indices.resolve_index-ignore_unavailable"];
        /** @description If `false`, the request returns an error if any wildcard expression, index alias, or `_all` value targets only missing or closed indices.
         *     This behavior applies even if the request targets other open indices.
         *     For example, a request targeting `foo*,bar*` returns an error if an index starts with `foo` but no index starts with `bar`. */
        allow_no_indices?: components["parameters"]["indices.resolve_index-allow_no_indices"];
        /** @description Filter indices by index mode - standard, lookup, time_series, etc. Comma-separated list of IndexMode. Empty means no filter. */
        mode?: components["parameters"]["indices.resolve_index-mode"];
      };
      header?: never;
      path: {
        /** @description Comma-separated name(s) or index pattern(s) of the indices, aliases, and data streams to resolve.
         *     Resources on remote clusters can be specified using the `<cluster>`:`<name>` syntax. */
        name: components["parameters"]["indices.resolve_index-name"];
      };
      cookie?: never;
    };
    requestBody?: components["requestBodies"]["indices.resolve_index"];
    responses: {
      200: components["responses"]["indices.resolve_index-200"];
    };
  };
  "indices-resolve-index-1": {
    parameters: {
      query?: {
        /** @description Type of index that wildcard patterns can match.
         *     If the request can target data streams, this argument determines whether wildcard expressions match hidden data streams.
