import{r as a,j as e,B as u,b2 as Q,k as p,n as g,bM as B,h as $,I as H,b3 as K,ag as F,ad as X}from"./mui-hXvMhbqI.js";import{bI as z,bJ as V,bK as J,M as Z,aK as ee,bL as N,ay as te,d as se,i as ne,l as oe,R as re}from"./index-BlQDgLEl.js";import{c as ie,h as ae,f as le}from"./ai-sdk-BNySMn_0.js";import{P as U}from"./PageContainer-B-Di_yS_.js";import{P as _}from"./PageHeader-Nk9Hv_ej.js";import"./perses-CkerAPsu.js";import"./codemirror-WwuEBBZ8.js";import"./echarts-D97nCBS2.js";const b=20,ce=6e4,ue=10,de=/^\s*my guess:\s*/im;function he(t){const s=b-t;return`You are playing **20 Questions** — a guessing game against a human who is thinking of something inside their Elasticsearch cluster. It could be a specific log entry, an index, a field value, an error, a service, a host — anything that lives in the cluster.

## Game Rules
- You have asked **${t}** questions so far. You have **${s}** remaining.
- You may ask at most **${b}** yes/no questions total.
...
`).map(o=>o.trim()).filter(o=>o.endsWith("?")&&o.length>0&&o.length<=120&&!o.startsWith("(")&&!o.startsWith("|")&&!o.startsWith("//")&&!o.startsWith("```")&&me.test(o)).length}function ye(t,s,l){const[o,c]=a.useState("idle"),[n,h]=a.useState([]),[y,j]=a.useState(0),[C,E]=a.useState(!1),[G,T]=a.useState(null),L=a.useRef(null),M=a.useRef([]),k=a.useRef(!1);a.useEffect(()=>{M.current=n,L.current?.scrollIntoView({behavior:"smooth"})},[n]);const x=a.useRef(0),A=a.useCallback((f,d)=>{h(i=>i.map(m=>m.id!==f?m:{...m,...d.content!==void 0?{content:d.content}:{},...d.toolCalls!==void 0?{toolCalls:d.toolCalls}:{}}))},[]),S=a.useCallback(async f=>{if(!s||k.current)return!1;k.current=!0,T(null),E(!0);const d=crypto.randomUUID();h(i=>[...i,{id:d,role:"assistant",content:"",toolCalls:[]}]);try{const i=ie({apiKey:t.apiKey,...t.provider==="openrouter"?{baseURL:"https://openrouter.ai/api/v1"}:{}}),m=t.provider==="openrouter"?i.chat(t.model):i(t.model),w=z(s),I=he(x.current),W=ae({model:m,system:I,messages:f.filter(r=>r.role!=="system").map(r=>({role:r.role,content:r.content})),tools:w,stopWhen:le(ue),abortSignal:AbortSignal.timeout(ce)});let R="",v=[];for await(const r of W.fullStream)r.type==="text-delta"?(R+=r.text,A(d,{content:R})):r.type==="tool-call"?(v=[...v,{toolCallId:r.toolCallId,name:r.toolName}],A(d,{toolCalls:v})):r.type==="tool-result"&&(v=v.map(q=>q.toolCallId===r.toolCallId?{...q,result:V(r.toolName,r.output)}:q),A(d,{toolCalls:v}));const D=fe(R);if(D>0&&v.length===0)return h(r=>r.filter(q=>q.id!==d)),T("The AI must inspect cluster data before asking the next question."),!1;if(D>0){const r=Math.max(0,b-x.current);x.current+=Math.min(D,r),j(x.current)}const P=de.test(R);return P&&c("guessing"),P}catch(i){const m=i instanceof DOMException&&(i.name==="AbortError"||i.name==="TimeoutError")?"Request timed out. Please try again.":i instanceof Error?i.message:String(i);return h(w=>w.filter(I=>I.id!==d)),T(m),!1}finally{k.current=!1,E(!1)}},[t,s,A]),Y=a.useCallback(async()=>{if(!s||!l||k.current)return;T(null),h([]),j(0),x.current=0,c("playing");const f={id:crypto.randomUUID(),role:"user",content:"I'm thinking of something in my Elasticsearch cluster. Start the game — explore the cluster and ask your first question!"};await S([f])},[s,l,S]),O=a.useCallback(async f=>{if(k.current)return;const d={id:crypto.randomUUID(),role:"user",content:f},i=[...M.current,d];if(h(i),o==="guessing"){const m=f.toLowerCase().trim(),w=m==="yes"||m==="yes, that's correct!";c(w?"won":"lost"),h(I=>[...I,{id:crypto.randomUUID(),role:"system",content:w?`🎉 The AI guessed it in ${x.current} questions!`:"The AI's guess was wrong. Better luck next time!"}]);return}if(x.current>=b){const m={id:crypto.randomUUID(),role:"user",content:f+`

(You have used all your questions. Make your final guess now.)`};await S([...M.current,m]);return}await S(i)},[o,S]);return{status:o,messages:n,questionCount:y,loading:C,error:G,messagesEndRef:L,startGame:Y,handleAnswer:O}}const ge=["p","br","strong","em","code","pre","ul","ol","li","blockquote"];function pe({toolCalls:t}){return t.length===0?null:e.jsx(u,{sx:{mb:.5},children:t.map(s=>e.jsx(p,{variant:"caption",sx:{display:"block",color:"text.secondary"},children:s.result?`✓ ${N(s.name)} — ${s.result}`:`⏳ ${N(s.name)}…`},s.toolCallId))})}function xe({msg:t,isActive:s}){const l=t.role==="user"?"flex-end":t.role==="system"?"center":"flex-start",o=t.role==="user"?"primary.main":t.role==="system"?"action.selected":"action.hover",c=t.role==="user"?"primary.contrastText":"text.primary",n=t.toolCalls??[];return e.jsx(u,{sx:{display:"flex",justifyContent:l},children:e.jsxs(Q,{elevation:0,sx:{maxWidth:t.role==="system"?"90%":"75%",py:1,px:2,borderRadius:2,bgcolor:o,color:c},children:[e.jsx(pe,{toolCalls:n}),t.role==="assistant"?t.content?e.jsx(u,{sx:{typography:"body2"},children:e.jsx(Z,{remarkPlugins:[ee],allowedElements:ge,skipHtml:!0,children:t.content})}):s&&n.length===0?e.jsx(p,{variant:"body2",color:"text.secondary",children:"Thinking…"}):null:e.jsx(p,{variant:"body2",sx:{whiteSpace:"pre-wrap",...t.role==="system"?{fontStyle:"italic"}:{}},children:t.content})]})})}function ve({status:t,onAnswer:s}){const[l,o]=a.useState(""),c=()=>{const n=l.trim();n&&(s(n),o(""))};return t==="guessing"?e.jsxs(u,{sx:{display:"flex",gap:1,justifyContent:"center"},children:[e.jsx(g,{variant:"contained",color:"success",onClick:()=>s("Yes, that's correct!"),children:"✅ Correct!"}),e.jsx(g,{variant:"contained",color:"error",onClick:()=>s("No, that's wrong."),children:"❌ Wrong"})]}):e.jsxs(u,{sx:{display:"flex",flexDirection:"column",gap:1},children:[e.jsxs(u,{sx:{display:"flex",gap:1,justifyContent:"center"},children:[e.jsx(g,{variant:"contained",onClick:()=>s("Yes"),children:"Yes"}),e.jsx(g,{variant:"outlined",onClick:()=>s("No"),children:"No"})]}),e.jsxs(u,{sx:{display:"flex",gap:1},children:[e.jsx($,{fullWidth:!0,size:"small","aria-label":"Your answer",placeholder:"Or type a more detailed answer…",value:l,onChange:n=>o(n.target.value),onKeyDown:n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),c())}}),e.jsx(H,{color:"primary",onClick:c,disabled:!l.trim(),"aria-label":"Send answer",children:e.jsx(K,{})})]})]})}function be({game:t}){const{status:s,messages:l,loading:o,error:c,messagesEndRef:n,startGame:h,handleAnswer:y}=t,j=s==="won"||s==="lost";return c?e.jsxs(u,{sx:{display:"flex",flex:1,flexDirection:"column",justifyContent:"center",alignItems:"center",gap:2},children:[e.jsx(Q,{variant:"outlined",sx:{p:2,maxWidth:480,borderColor:"error.dark",bgcolor:"error.main",color:"error.contrastText"},children:e.jsx(p,{variant:"body2",children:c})}),e.jsx(g,{variant:"contained",onClick:h,children:"Try Again"})]}):s==="idle"?e.jsxs(u,{sx:{display:"flex",flex:1,flexDirection:"column",justifyContent:"center",alignItems:"center",gap:2},children:[e.jsx(p,{variant:"h6",color:"text.secondary",children:"How to Play"}),e.jsxs(p,{variant:"body2",color:"text.secondary",sx:{maxWidth:480,textAlign:"center"},children:["Think of something in your Elasticsearch cluster — a specific log entry, an index, a service, a host, an error message, or anything else that lives in the data. Click"," ",e.jsx("strong",{children:"New Game"})," and the AI will query the cluster and ask you up to"," ",b," yes/no questions to figure out what you're thinking of."]})]}):e.jsxs(u,{sx:{display:"flex",flex:1,flexDirection:"column",minHeight:0,gap:1},children:[e.jsxs(Q,{variant:"outlined",role:"log","aria-live":"polite","aria-relevant":"additions text","aria-busy":o,sx:{display:"flex",flex:1,flexDirection:"column",gap:1.5,minHeight:0,overflowY:"auto",p:2},children:[l.map((C,E)=>e.jsx(xe,{msg:C,isActive:o&&C.role==="assistant"&&E===l.length-1},C.id)),e.jsx("div",{ref:n})]}),!j&&!o&&e.jsx(ve,{status:s,onAnswer:y}),o&&e.jsx(u,{sx:{display:"flex",justifyContent:"center",py:1},children:e.jsx(B,{sx:{width:120}})}),j&&e.jsx(u,{sx:{display:"flex",justifyContent:"center",py:1},children:e.jsx(g,{variant:"contained",onClick:h,children:"Play Again"})})]})}function Te(){const{config:t,isConfigured:s}=te(se(y=>({config:y.config,isConfigured:y.isConfigured}))),l=ne(y=>y.connection),o=oe(),c=s(),n=ye(t,l,c),h=n.status==="won"||n.status==="lost";return c?e.jsxs(U,{gap:1.5,children:[e.jsx(_,{title:"20 Questions",description:"Think of something in your cluster — the AI queries Elasticsearch to guess what it is",actions:e.jsxs(u,{sx:{display:"flex",gap:1,alignItems:"center"},children:[(n.status==="playing"||n.status==="guessing")&&e.jsx(X,{label:`${n.questionCount} / ${b} questions`,color:n.questionCount>=b-5?"warning":"default"}),e.jsx(g,{variant:"contained",onClick:n.startGame,disabled:n.loading,children:n.status==="idle"?"New Game":h?"Play Again":"Restart"})]})}),e.jsx(be,{game:n})]}):e.jsxs(U,{children:[e.jsx(_,{title:"20 Questions",description:"Think of something in your cluster — the AI queries Elasticsearch to guess what it is"}),e.jsxs(u,{sx:{display:"flex",flex:1,flexDirection:"column",gap:2,justifyContent:"center",alignItems:"center"},children:[e.jsx(p,{variant:"subtitle1",color:"text.secondary",children:"LLM provider not configured"}),e.jsx(p,{variant:"body2",color:"text.secondary",sx:{mb:1},children:"Configure an API key in Settings to play 20 Questions."}),e.jsx(g,{variant:"contained",startIcon:e.jsx(F,{}),onClick:()=>o(re.settings.path),children:"Go to Settings"})]})]})}export{Te as default};
//# sourceMappingURL=TwentyQuestionsPage-BHdMaf1p.js.map
