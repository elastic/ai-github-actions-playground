...
| SORT bucket ASC`}function Z(e,t,n){const s=T(e);return`TS metrics-hostmetricsreceiver*
...
| STATS
    ...
    load_15m = MAX(AVG_OVER_TIME(\`system.cpu.load_average.15m\`))
  BY bucket = BUCKET(@timestamp, 20, ${t.timeFrom}, ${t.timeTo})
| SORT bucket ASC`}function ee(e){if(!e?.columns||!e.values)return[];const t=e.columns.findIndex(s=>s.name==="bucket"),n=e.columns.findIndex(s=>s.name==="metric_value");return t<0||n<0?[]:e.values.map(s=>({bucket:String(s[t]??""),value:typeof s[n]=="number"?s[n]:0})).filter(s=>s.bucket)}function te(e){if(!e?.columns||!e.values)return[];const t=e.columns.findIndex(o=>o.name==="bucket"),n=e.columns.findIndex(o=>o.name==="load_1m"),s=e.columns.findIndex(o=>o.name==="load_5m"),c=e.columns.findIndex(o=>o.name==="load_15m");return t<0?[]:e.values.map(o=>({bucket:String(o[t]??""),load1m:typeof o[n]=="number"?o[n]:0,load5m:typeof o[s]=="number"?o[s]:0,load15m:typeof o[c]=="number"?o[c]:0})).filter(o=>o.bucket)}function u(e,t){return e.findIndex(n=>n.name===t)}function m(e,t){if(t<0||t>=e.length)return"";const n=e[t];return typeof n=="string"?n:n!=null?String(n):""}function y(e,t){if(t<0||t>=e.length)return null;const n=e[t];return typeof n=="number"&&Number.isFinite(n)?n:null}function ne(e){const t=e.columns??[],n=e.values??[];if(t.length===0||n.length===0)return[];const s=u(t,"host_key"),c=u(t,"host_name"),o=u(t,"os_type"),a=u(t,"os_name"),l=u(t,"os_version"),d=u(t,"os_full"),_=u(t,"last_seen"),h=u(t,"cpu_utilization"),p=u(t,"memory_utilization"),r=u(t,"process_count"),S=u(t,"load_avg_1m"),b=u(t,"host_arch"),I=u(t,"host_ip");return n.map(i=>({hostId:m(i,s)||"unknown",hostName:m(i,c),osType:$(m(i,o)),osName:m(i,a),osVersion:m(i,l),osFull:m(i,d),lastSeen:m(i,_),cpuUtilization:y(i,h),memoryUtilization:y(i,p),processCount:y(i,r),loadAvg1m:y(i,S),hostArch:m(i,b),hostIp:m(i,I)||void 0}))}export{j as M,D as a,U as b,z as c,Y as d,P as e,q as f,ee as g,W as h,G as i,ne as j,J as k,Z as l,K as m,B as o,te as p,V as t,Q as u};
//# sourceMappingURL=hostHelpers-_F5m2Tke.js.map
