...
| STATS
    ...
    host_ip = MAX(host.ip)
  BY host_key
| SORT last_seen DESC`}function Z(e,t){const n=A(e);return`FROM metrics-hostmetricsreceiver*
...
| EVAL
    ...
    host_arch = host.arch,
    host_ip = host.ip
| KEEP host_key, host_name, os_type, os_name, os_version, os_full, last_seen, cpu_utilization, memory_utilization, process_count, load_avg_1m, host_arch, host_ip`}function J(e,t){return`TS metrics-hostmetricsreceiver*
| WHERE ${g(t).join(" AND ")}
...
| STATS
    ...
    load_15m = MAX(AVG_OVER_TIME(\`system.cpu.load_average.15m\`))
  BY bucket = BUCKET(@timestamp, 20, ${t.timeFrom}, ${t.timeTo})
| SORT bucket ASC`}function oe(e){if(!e?.columns||!e.values)return[];const t=b(e.columns),n=f(t,"bucket"),i=f(t,"metric_value");return n<0||i<0?[]:e.values.map(s=>({bucket:String(c(s,n)??""),value:typeof c(s,i)=="number"?c(s,i):0})).filter(s=>s.bucket)}function se(e){if(!e?.columns||!e.values)return[];const t=b(e.columns),n=f(t,"bucket"),i=f(t,"load_1m"),s=f(t,"load_5m"),l=f(t,"load_15m");return n<0?[]:e.values.map(o=>({bucket:String(c(o,n)??""),load1m:typeof c(o,i)=="number"?c(o,i):0,load5m:typeof c(o,s)=="number"?c(o,s):0,load15m:typeof c(o,l)=="number"?c(o,l):0})).filter(o=>o.bucket)}function a(e,t){return e.findIndex(n=>n.name===t)}function m(e,t){if(t<0||t>=e.length)return"";const n=e[t];return typeof n=="string"?n:n!=null?String(n):""}function E(e,t){if(t<0||t>=e.length)return null;const n=e[t];return typeof n=="number"&&Number.isFinite(n)?n:null}function re(e){const t=e.columns??[],n=e.values??[];if(t.length===0||n.length===0)return[];const i=a(t,"host_key"),s=a(t,"host_name"),l=a(t,"os_type"),o=a(t,"os_name"),p=a(t,"os_version"),d=a(t,"os_full"),h=a(t,"last_seen"),y=a(t,"cpu_utilization"),_=a(t,"memory_utilization"),r=a(t,"process_count"),v=a(t,"load_avg_1m"),O=a(t,"host_arch"),I=a(t,"host_ip");return n.map(u=>({hostId:m(u,i)||"unknown",hostName:m(u,s),osType:C(m(u,l)),osName:m(u,o),osVersion:m(u,p),osFull:m(u,d),lastSeen:m(u,h),cpuUtilization:E(u,y),memoryUtilization:E(u,_),processCount:E(u,r),loadAvg1m:E(u,v),hostArch:m(u,O),hostIp:m(u,I)||void 0}))}export{K as M,U as a,Q as b,W as c,ee as d,J as e,j as f,oe as g,G as h,Y as i,re as j,ne as k,te as l,Z as m,q as o,se as p,D as t,P as u};
//# sourceMappingURL=hostHelpers-DdedOckw.js.map
